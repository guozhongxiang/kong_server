...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
		<div class="am-cf am-padding">
			...
			<strong class="am-text-primary am-text-lg">权限组列表</strong>
			<a type="button" class="am-btn am-btn-default am-btn-xs" href="<?php echo U('admin/Authgroup/add');?>"><span class="am-icon-plus"></span> 新增</a></div>
		</div> 
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
				<th class="table-title">权限组名称</th>
				<th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody>
		  <?php if(is_array($group_list)): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
              <td><?php echo ($data['group_name']); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a class="am-btn am-btn-default am-btn-xs am-text-secondary edit" href="<?php echo U('admin/Authgroup/edit','id='.$data['id']);?>"><span class="am-icon-pencil-square-o"></span>设置权限组</a>
                  </div>
                </div>
              </td>
