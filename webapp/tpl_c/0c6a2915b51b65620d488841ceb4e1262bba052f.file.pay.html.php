<?php /* Smarty version Smarty-3.1.19, created on 2016-04-07 14:18:29
         compiled from "C:\phpStudy\WWW\kongtiao\kong_server\webapp\tpl\wxq\airConditionClean\pay.html" */ ?>
<?php /*%%SmartyHeaderCode:156235702956aead6b6-78828409%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c6a2915b51b65620d488841ceb4e1262bba052f' => 
    array (
      0 => 'C:\\phpStudy\\WWW\\kongtiao\\kong_server\\webapp\\tpl\\wxq\\airConditionClean\\pay.html',
      1 => 1460009901,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '156235702956aead6b6-78828409',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5702956aead6b7_88712233',
  'variables' => 
  array (
    '__host__' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_5702956aead6b7_88712233')) {function content_5702956aead6b7_88712233($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
<head>
...
<div class="content">
    <p class="cg bb tit">服务ID <span class="cb fr fs14"><a href="ktqx-xg.html" class="cb">修改</a></span><div class="clear"></div></p>
    ...
    <div class="bgg pr" style="border-radius: 4px;margin-top:5px;">
        <select class="lh24 w100 bgg pdy13 pdx fs14" id="select">

        </select>
        <img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/xjt.png" class="icon pa bgg" style="top:10px; right:0;" alt="">
    </div>
        ...
        <!-- <div class="w100 mc pr">
            <div class="w100 h">
                <div class="pl pr tc fl">
                    <p class="tc pr line l"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
...
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                ...
                <div class="pl pr tc fl">
                    <p class="tc pr line lg"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/wwc.PNG" class="w40 imgstate" alt="" /></p>
...
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/n.PNG" class="w40 wicon" style="margin-bottom:-6px;" alt=""/><span class="fs12 pro cb">派单</span></p>
                </div>
                <div class="pl pr tc fl">
                    <p class="tc pr line l"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><span class="fs12 pro cb">接单</span></p>
                </div>
                <div class="pl pr tc fl">
                    <p class="tc pr line l"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><span class="fs12 pro cb">提交工单</span></p>
                </div>
                <div class="pl pr tc fl">
                    <p class="tc pr line l"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><span class="fs12 pro cb">确认工单</span></p>
                </div>
                <div class="pl pr tc fl">
                    <p class="tc pr line l"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/ywc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><span class="fs12 pro cb">定价</span></p>
                </div>
                <div class="pl pr tc fl">
                    <p class="tc pr line lg"><img src="<?php echo $_smarty_tpl->tpl_vars['__host__']->value;?>
img/wxq/wwc.PNG" class="w40 imgstate" alt="" /></p>
                    <p class="tc"><span class="fs12 pro">付款</span></p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
...
index.php?mod=wxq&act=orderStatus">-->
    <div class="w80 mc tc cw bgb pdy8" style="margin-bottom:20px;border-radius:6px;" id="pay">
        付款
    </div>
<!--</a>-->
...
index.php?mod=order&act=orderPayAjax",
      type :      "post",
      dataType :  "json",
      data : {
...
/index.php?mod=wxq&act=airConditionComplainComment";
        } else {
          alert(data.Msg);
        }
      },
